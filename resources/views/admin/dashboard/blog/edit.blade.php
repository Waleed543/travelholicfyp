                        ...
                        <div class="col-md-10">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form  id="update" method="post" action="{{route('blog.update',$blog->slug)}}" enctype="multipart/form-data" class="form-horizontal">
                                        {{ csrf_field() }}
                                        @method('PUT')
                                        <div class="row form-group" id="bloodhound">
                                            ...
                                            <div class="col-12 col-md-3">
                                                <input type="text" data-role="tagsinput" id="blood" name="tags" value="{{old('tags') ?? implode(',',$blog->tags->pluck('name')->toArray())}}" class="form-control @error('tags') is-invalid @enderror">
                                                @error('tags')
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-3">
                                                <input type="text" id="title" name="title" value="{{old('title') ? old('title') : $blog->title}}" class="form-control @error('title') is-invalid @enderror" required>
                                                @error('title')
                                                <span class="invalid-feedback" role="alert">
                                                         <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-12">
                                                <textarea id="inputContent" name="body"class="form-control @error('body') is-invalid @enderror">{{old('body') ? old('body') : $blog->body}}</textarea>
                                                @error('body')
                                                <span class="invalid-feedback" role="alert">
                                                         <strong>{{ $message }}</strong>
                                                    </span>
                                                ...
                                                <select multiple name="categories[]" id="select" class="form-control @error('categories') is-invalid @enderror" required>
                                                    ...
                                                    @if(count($categories)>0)
                                                        @foreach($categories as $category)
                                                            @if(old('categories')? in_array($category->id, old('categories')) :in_array($category->id , $blog->categories->pluck('id')->toArray()))
