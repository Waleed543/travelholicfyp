                    ...
                    <div class="row pt-md-5 mt-md-3">
                        <div class="col-xl-3 col-sm-6 p-2">
                            <div class="card">
                                ...
                                <a href="{{route('admin.dashboard.hotel.room.create',$slug)}}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-inline" role="group">
                                                ...
                                                <form id="edit-hotel-{{$loop->iteration}}" action="{{ route('admin.dashboard.hotel.room.edit',[$slug,$room->slug]) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('GET')
                                                </form>
                                                {{-- Delete Tour Button--}}
...
@section('js')
    <script>
        function submit_status_form(hotel_slug, room_slug) {
            ...
            $.ajax({
                url:"/admin/dashboard/hotel/"+hotel_slug+"/room/"+room_slug+"/status/update",
                method:"POST",
