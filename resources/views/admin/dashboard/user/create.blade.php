...
@section('headerName', 'Create User')
@section('content')
    <section>
                        ...
                        <div class="col-md-10">
                            <div class="card">
                                <div class="card-header">
                                    <strong>CreateS Blog</strong>
                                </div>
                                <div class="card-body card-block">
                                    <form  id="create" method="post" action="{{route('admin.dashboard.user.store')}}" enctype="multipart/form-data" class="form-horizontal">
                                        {{ csrf_field() }}
