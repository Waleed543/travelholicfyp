...
@section('title','Tour Update')
@section('tour','current')
@section('headerName', 'Update Tour')
@section('content')
@section('css')
                                    ...
                                    <form  id="update" method="post" action="{{route('tour.update',$tour->slug)}}" enctype="multipart/form-data" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" id="name" name="name" value="{{old('name') ? old('name') : $tour->name}}" class="form-control @error('name') is-invalid @enderror" required>
                                                @error('name')
                                                <span class="invalid-feedback" role="alert">
                                                         <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="row form-group">
                                                ...
                                                <select name="destination_city" id="destination_city" class="form-control @error('destination_city') is-invalid @enderror" required>
                                                    ...
                                                    @if(count($cities)>0)
                                                        @foreach($cities as $city)
                                                            @if(old('destination_city') ? old('destination_city') : $tour->destination_city == $city->id)
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <select name="departure_city" id="departure_city" class="form-control @error('departure_city') is-invalid @enderror" required>
                                                    ...
                                                    @if(count($cities)>0)
                                                        @foreach($cities as $city)
                                                            @if(old('departure_city') ? old('departure_city') : $tour->departure_city == $city->id)
                                                                <option selected value="{{$city->id}}">{{$city->name}}</option>
                                                            @else
                                                                <option value="{{$city->id}}">{{$city->name}}</option>
                                                            @endif
