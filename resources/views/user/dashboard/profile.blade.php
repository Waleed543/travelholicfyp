                    ...
                    <div class="row pt-md-5 mt-md-3 mb-5">
                        <div class="col-lg-6">
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form  id="update" method="post" action="{{route('update.profile')}}" enctype="multipart/form-data" class="form-horizontal">
                                        {{ csrf_field() }}
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                        ...
                                        <div class="card-body card-block">
                                            <form  id="update-password" method="post" action="{{route('update.password')}}" enctype="multipart/form-data" class="form-horizontal">
                                                @csrf
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form  id="update-image" method="post" action="{{route('update.image')}}" enctype="multipart/form-data" class="form-horizontal">
                                        @csrf
